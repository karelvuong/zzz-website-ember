  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el4 = dom.createTextNode("Websites");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n	");
        dom.appendChild(el2, el3);
        ...
        dom.setAttribute(el2,"href","http://1MMM.org");
        var el3 = dom.createTextNode("\n		");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        ...
        var el6 = dom.createTextNode("1 Million Music Moments");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n		    ");
        dom.appendChild(el4, el5);
        ...
        var el6 = dom.createTextNode("The website for 1 Million Music Moments (1MMM), a non-profit organization that seeks to strengthen the City of Toronto's reputation as a world class music and cultural centre.");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n			");
        dom.appendChild(el4, el5);
        ...
        var el2 = dom.createElement("a");
        dom.setAttribute(el2,"class","portfolio-work");
        dom.setAttribute(el2,"href","http://thetyc.ca");
        var el3 = dom.createTextNode("\n		");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","portfolio-work-screenshot");
        ...
        var el5 = dom.createElement("p");
        dom.setAttribute(el5,"class","portfolio-work-information-title");
        var el6 = dom.createTextNode("Toronto Youth Cabinet");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n		    ");
        dom.appendChild(el4, el5);
        ...
        var el5 = dom.createElement("p");
        dom.setAttribute(el5,"class","portfolio-work-information-description");
        var el6 = dom.createTextNode("The website for the Toronto Youth Cabinet, the official youth advisory body for the City of Toronto.");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n			");
        dom.appendChild(el4, el5);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("p");
        dom.setAttribute(el5,"class","post-section-header-blurb lead");
        var el6 = dom.createTextNode("A look into the design process.");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n      ");
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        dom.setAttribute(el4,"class","post-section-text lead");
        ...
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(" in January, I took on the task of redesigning the settings pages on Zazzle.com.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("I started the redesign project in late March of 2015. While there were a number of other exciting projects ongoing, I wanted to take on a project that I could work through from the beginning all the way to the very end - from ideation to implementation. Coupled with the fact that my internship was coming to an end at the end of April 2015, this was the perfect project.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("While not entirely public facing, the settings pages play a key role on Zazzle.com. Any changes that need to be made to a user's profile and account settings, or a store owner's products, payment information, and tax settings are controlled on these pages. And it is here where users provide both public and sensitive information to us.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n\n      ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(" I was the primary designer and was responsible for the creation of all designs, mockups, and wireframes, and also managed development for the implementation of the settings pages.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("Prior to the redesign, the settings were difficult to navigate. User testing was conducted to evaluate the usability of the pages and are summarized into the sections below.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n\n      ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("A user's settings was accessed by hovering over the icon of the member's profile picture in the header and clicking ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("strong");
        var el6 = dom.createTextNode("My Accounts");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(". Modifying your profile on a different page may lead to some confusion as you are no longer on the page you are editing. Sites like Facebook and Houzz address this by allowing users to edit their information from directly on the profile.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("h1");
        var el5 = dom.createTextNode("Context");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("Related to the points made above, editing your profile information or account settings performed on pages that look very similar and generic, making it difficult to distinguish whether you are within the member context or the store context.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n\n      ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("In its current state, it is unclear how to navigate to different sections of the user and store settings. While the flow was designed to be hierarchical, sections are displayed as though they all sit on the same level, despite being a child of a parent. The navigation boils down to a horizontal navigation bar and a side panel.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        dom.appendChild(el3, el4);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph2 = dom.createMorphAt(dom.childAt(element0, [3, 1, 9, 0]),1,1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el10, el11);
        var el11 = dom.createElement("a");
        dom.setAttribute(el11,"href","http://1MMM.org");
